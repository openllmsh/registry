#!/usr/bin/env bash
# openllm-self-sha256: 6be27a7e008224a70271f9d1442954c0bcf69e2317684882c1710780a4a4ca4b
...
record_install_stamp() {
  ...
  (umask 077; printf '%s' "1.6.39-registry.8" > "$tmp" && mv -f "$tmp" "$dir/setup-cli.version") 2>/dev/null || { rm -f "$tmp"; true; }
